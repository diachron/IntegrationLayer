 ...
 * @author panos
 */
@Path("/complexChangeQueryHandler")
public class ComplexChangeQueryHandler
{
    @Context
    private UriInfo context;

    public ComplexChangeQueryHandler()
    {
    }
    ...
    public String inputQueue(@PathParam("id")String id, String inputMessage)
    {
        try
        {
            ...
            ClientResponse clientResponse = complexChangeManager.sendQuery(inputMessage);
