...
@Path("ComplexChangeQueryDispatcher")
public class ComplexChangeQueryDispatcherResource
{
    @Context
    private UriInfo context;

    public ComplexChangeQueryDispatcherResource() {
    }
        ...
        Thread thread = new Thread()
        {
            ...
            public void run() 
            {
                ...
                WebResource webResource = client
                    .resource(propertiesManager.getPropertyValue("BaseServer") + "/complexChangeQueryHandler/"
